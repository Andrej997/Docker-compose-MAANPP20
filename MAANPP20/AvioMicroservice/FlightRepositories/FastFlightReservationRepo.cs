...
namespace AvioMicroservice.FlightRepositories
{
    public class FastFlightReservationRepo : IFastFlightReservation
    {
        ...
        public async Task<ActionResult<FastFlightReservation>> DeleteFastFlightReservation(MAANPP20ContextFlight _context, int id)
        {
        ...
        public async Task<ActionResult<IEnumerable<FastFlightReservation>>> GetFastFlightReservations(MAANPP20ContextFlight _context, string idUser)
        {
        ...
        public async Task<ActionResult<IEnumerable<FastFlightReservation>>> GetFastFlightReservationsStatistics(MAANPP20ContextFlight _context, int idFlight)
        {
            return await _context.FastFlightReservations
                .Where(x => x.deleted == false)
        ...
        public async Task<FastFlightReservation> UpdateFastFlightReservation(MAANPP20ContextFlight _context, FastFlightReservation fastFlightReservation)
        {
        ...
        private bool FastFlightReservationExists(MAANPP20ContextFlight _context, int id) => _context.FastFlightReservations.Any(e => e.id == id);
