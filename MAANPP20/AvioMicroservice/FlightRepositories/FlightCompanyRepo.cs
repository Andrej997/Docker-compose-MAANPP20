...
namespace AvioMicroservice.FlightRepositories
{
    public class FlightCompanyRepo : IFlightCompany
    {
        ...
        public async Task<ActionResult<IEnumerable<FlightCompany>>> GetFlightCompany(MAANPP20ContextFlight _context)
        {
        ...
        private bool FlightCompanyExists(MAANPP20ContextFlight _context, int id) => _context.FlightCompanies.Any(e => e.id == id);
    }
}
